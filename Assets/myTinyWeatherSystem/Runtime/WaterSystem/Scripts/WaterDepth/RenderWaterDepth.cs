...
namespace Yu_Weather
{
    ...
    public class RenderWaterDepth : MonoBehaviour
    {
        ...
        {
            if (!perCamDepth && bRenderedSceneDepth)
            {
        ...
        private void RenderDepthForCam(ScriptableRenderContext context, Camera cam = null)
        {
            ...
            curParams = new Vector4(depthCam.transform.position.x, depthCam.transform.position.y, depthCam.transform.position.z,depthCam.orthographicSize);
        ...
        private void SetDepthCamShaderVariables()
        {
            ...
            Shader.SetGlobalVector(_WaterDepthParams, curParams);
        }
