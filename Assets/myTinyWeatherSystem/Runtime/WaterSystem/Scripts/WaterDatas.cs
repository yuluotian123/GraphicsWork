...
namespace Yu_Weather
{
    public class WaterSurfaceDatas
    {
        ...
        public void Update(FFTOcean fftOcean,ComputeShader GaussianCS)
        {
            ...
            postProcessing = fftOcean.PostProcessing;
            if (!postProcessing)
            {
        ...
        public void UpdateSurfaceParameters(FFTOcean fftOcean)
        {
            ...
            surfaceParameters._MeshScale = new Vector4(fftOcean.meshScale.x, fftOcean.meshScale.y, fftOcean.normalScale, 0);
        }
    ...
    public class WaterRenderingDatas
    {
        ...
        public void UpdatePerFrame(FFTOcean fftOcean)
        {
            ...
            if (RampTexture == null)
            {
                ...
                var defaultFoamRamp = fftOcean.foamRamp;
        ...
        public void UpdateShaderVariable(FFTOcean fftOcean)
        {
            ...
            renderParameters._LightIntensityScale = fftOcean.lightIntensityScale;
            renderParameters._SpecColor = fftOcean.SpecColor;
            renderParameters._Shininess = fftOcean.shinness;
            renderParameters._Shadow = fftOcean.shadow;

            renderParameters._UnUsed0 = 0;

            renderParameters._FoamAdd = fftOcean.foamAdd;
            renderParameters._FoamEdge = fftOcean.foamEdge;
        ...
        public readonly int _FoamMap = Shader.PropertyToID("_FoamMap");
